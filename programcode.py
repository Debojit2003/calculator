...
txtDisplay = Entry(calc, font=('green',20,'italic'),
				bg='blue',fg='red',
...
btnsq = Button(calc, text="\u221A",width=6, height=2,
			bg='powder blue', font=('Baskerville',
									20,'italic'),
...
btnPM = Button(calc, text=chr(177),width=6,
			height=2,bg='powder blue', font=('Baskerville',20,'italic'),
